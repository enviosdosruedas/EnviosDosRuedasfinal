  ...
  return (
    <section className="w-full py-12 md:py-20 lg:py-28 bg-gradient-to-br from-primary via-primary/90 to-primary/80 text-primary-foreground">
      <div className="container mx-auto px-4 md:px-6 text-center">
        <Badge variant="secondary" className="text-sm sm:text-base py-1.5 px-4 shadow-lg mb-6 font-sans">
        ...
        <p className="text-lg md:text-xl text-primary-foreground/90 max-w-3xl mx-auto mb-8 font-sans">
        ...
        <div className="flex flex-col sm:flex-row justify-center items-center gap-4">
          <Button size="lg" asChild className="bg-secondary hover:bg-secondary/90 text-secondary-foreground font-sans">
