  ...
  return (
    <>
      <HeroSection
        ...
        description={
          <div className="space-y-4 font-sans">
            ...
            <div className="mt-3 sm:mt-4 md:mt-6">
              <h2 className="text-xl sm:text-2xl md:text-3xl font-semibold text-primary-foreground mb-0.5 sm:mb-1 font-display">
                Envios DosRuedas
              </h2>
        ...
        ctaButtons={[
          { text: "Cotizar Envío Express", href: "/cotizar/express", variant: "secondary", icon: "Calculator", className:"text-sm sm:text-lg py-2.5 sm:py-3 px-5 sm:px-7 font-sans" },
          { text: "Ver Tarifas", href: "#express-pricing-ranges", variant: "outline", className: "bg-transparent border-primary-foreground/70 text-primary-foreground hover:bg-primary-foreground/10 hover:text-primary text-sm sm:text-lg py-2.5 sm:py-3 px-5 sm:px-7 font-sans", icon: "ArrowRight" },
        ]}
        ...
        titleClassName="text-4xl sm:text-5xl md:text-6xl font-bold font-display"
